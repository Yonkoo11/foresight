...
export async function up(knex: Knex): Promise<void> {
  ...
  await knex('prize_distribution_rules').insert([
    { min_players: 2, max_players: 9, rank: 1, percentage: 50, label: '1st' },
    { min_players: 2, max_players: 9, rank: 2, percentage: 30, label: '2nd' },
    { min_players: 2, max_players: 9, rank: 3, percentage: 20, label: '3rd' },
  ]);
}
